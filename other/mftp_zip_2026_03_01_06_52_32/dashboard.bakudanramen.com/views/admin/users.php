...
<div class="grid grid-2">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="flex gap-2">
                                <a href="<?= APP_URL ?>/admin/users/<?= $u['id'] ?>/toggle" class="btn btn-ghost btn-sm" title="Toggle active">
                                    <?= $u['is_active'] ? '🔒' : '🔓' ?>
                                </a>
                                <a href="<?= APP_URL ?>/admin/users/<?= $u['id'] ?>/delete" class="btn btn-ghost btn-sm" onclick="return confirm('Xóa tài khoản <?= e($u['name']) ?>?')" title="Xóa">🗑</a>
                            </div>
                            <?php else: ?>
    ...
    <!-- Create User -->
    <div class="card">
        <div class="card-header"><h3>Tạo tài khoản mới</h3></div>
        <div class="card-body">
